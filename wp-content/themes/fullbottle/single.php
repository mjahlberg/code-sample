            ...
            <div class="row">
              <div class="col-md-12">
               <section class="post-meta">
                <p class="author-avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ), 50 ); ?><ba><?php the_author_meta( 'display_name' ); ?> <i style="font-size: 11px;">ON <?php the_date(); ?></i></ba></p>
              </section><!-- end of .post-meta -->

              <h4 style="font-size: 3em;"><?php the_title(); ?></h4>
