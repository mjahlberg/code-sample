...
<section>
    ...
    <div class="col-md-8 posts">
      ...
      <?php while (have_posts()) : the_post(); ?>
              <article id="post-<?php the_ID(); ?>" style="  padding-top: 50px;">
                <div class="container">
                  <div class="row">
                    <div class="col-lg-12 post" >
                      <section class="post-meta">
                          <p class="author-avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ), 50 ); ?><ba><?php the_author_meta( 'display_name' ); ?> / <?php the_date(); ?></ba></p>
                      ...
                      <?php endif; ?>
                      <?php the_content(); ?>
                        <a class="btn btn-primary btn-blue btn-solid " href="<?php the_permalink(); ?>">CONTINUE READING</a>
